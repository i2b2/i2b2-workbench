...
public class ProtectRequestMessage extends WorkplaceRequestData {
	
	public static final String THIS_CLASS_NAME = ProtectRequestMessage.class.getName();
    private Log log = LogFactory.getLog(THIS_CLASS_NAME);	

    private ProtectedType protectType;

	public ProtectRequestMessage() {}
	 ...
	 */
	public ProtectedType protectType() { 
	...
	public BodyType getBodyType() {
		...
		bodyType.getAny().add(of.createSetProtectedAccess(childType));
		return bodyType;
	}
	...
	public BodyType getBodyType(ProtectedType childType) {
		edu.harvard.i2b2.wkplclient.datavo.wdo.ObjectFactory of = new edu.harvard.i2b2.wkplclient.datavo.wdo.ObjectFactory();
	 ...
	 */
	public String doBuildXML(ProtectedType nodeData){ 
