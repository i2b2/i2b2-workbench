...
import edu.harvard.i2b2.eclipse.plugins.query.workplaceMessaging.ExportChildRequestMessage;
import edu.harvard.i2b2.eclipse.plugins.query.workplaceMessaging.WorkplaceRequestData;
...
public class XmlUtil {
	...
	//			.convertDOMElementToString(element);
		...
		edu.harvard.i2b2.common.util.jaxb.JAXBUtil jaxbUtil = QueryJAXBUtil.getJAXBUtil();
	...
	{    	
		...
		if (nameElements.getLength() != 0){
			...
			return null;//MessageUtil.getInstance().getTimestamp();
		}
	}
