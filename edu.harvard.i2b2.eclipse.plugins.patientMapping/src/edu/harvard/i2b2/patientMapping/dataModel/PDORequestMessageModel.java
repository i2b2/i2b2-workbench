...
public class PDORequestMessageModel {
	...
	public GetPDOFromInputListRequestType getPDOFromInputListRequestType(String id, int min, int max) {
	...
	public GetPDOFromInputListRequestType getPDOFromInputListRequestTypePid(String id) {

		PatientListType patientListType = new PatientListType();
		PatientListType.PatientId pid = new PatientListType.PatientId();
		pid.setValue(id);
		patientListType.getPatientId().add(pid);
		//patientListType.setPatientSetCollId(id);
		/*if (patientSetRefId.compareTo("-1") == 0) {
			patientListType.setPatientSetCollId(null);
			patientListType.setEntirePatientSet(true);
	...
	public String requestXmlMessage(String id, int min, int max)
			throws Exception {
		...
		GetPDOFromInputListRequestType patientSetRequestType = getPDOFromInputListRequestType(id, min, max);
	...
	public String requestXmlMessagePid(String id) throws Exception {
		PdoQryHeaderType headerType = buildHeaderType();
		// GetPDOFromPatientSetRequestType patientSetRequestType =
		// buildPatientSetRequestType();
		
		GetPDOFromInputListRequestType patientSetRequestType = getPDOFromInputListRequestTypePid(id);
		ObjectFactory obsFactory = new ObjectFactory();
