...
public class SetUserPasswordRequestMessage extends ProjectManagementRequestData {
	
	public static final String THIS_CLASS_NAME = SetUserPasswordRequestMessage.class.getName();
    
	private Log log = LogFactory.getLog(THIS_CLASS_NAME);	
	private SecurityType securityType = null;

	public SetUserPasswordRequestMessage(String uname, PasswordType pword, String domain) {
	 ...
	 * @return A String data type containing the Ont RequestMessage in XML format
	 */
	public String doBuildXML(UserType password){ 
		String requestString = null;
			try {
				MessageHeaderType messageHeader = getMessageHeader(); 
