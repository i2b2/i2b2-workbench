 ...
 *
 */
public class UpdateConceptTotalNumResponseMessage extends OntologyResponseData {
	
	public static final String THIS_CLASS_NAME = UpdateConceptTotalNumResponseMessage.class.getName();

    private ResponseMessageType respMessageType = null;
    private Log log = LogFactory.getLog(THIS_CLASS_NAME);	


    public UpdateConceptTotalNumResponseMessage() {}
	
	public OntologyProcessStatusType doReadProcessStatus(){
		OntologyProcessStatusType concepts = null;
			try {
				BodyType bodyType = respMessageType.getMessageBody();
				JAXBUnWrapHelper helper = new JAXBUnWrapHelper(); 
				concepts = (OntologyProcessStatusType)helper.getObjectByClass(bodyType.getAny(), OntologyProcessStatusType.class);
