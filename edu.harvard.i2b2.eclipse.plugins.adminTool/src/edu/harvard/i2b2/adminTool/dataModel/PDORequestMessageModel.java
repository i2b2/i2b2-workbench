...
import edu.harvard.i2b2.crcxmljaxb.datavo.im.query.GetAuditType;
import edu.harvard.i2b2.crcxmljaxb.datavo.im.query.IsKeySetType;
//import edu.harvard.i2b2.crcxmljaxb.datavo.im.query.PidType;
import edu.harvard.i2b2.crcxmljaxb.datavo.im.query.SetKeyType;
...
public class PDORequestMessageModel {
	...
	public GetPDOFromInputListRequestType getPDOFromInputListRequestType(String id) {

		PatientListType patientListType = new PatientListType();
		patientListType.setPatientSetCollId(id);
		/*if (patientSetRefId.compareTo("-1") == 0) {
			patientListType.setPatientSetCollId(null);
			patientListType.setEntirePatientSet(true);
		} else {
	...
	public SetKeyType getSetKeyRequestType(String key, String projectID) {

		SetKeyType patientListType = new SetKeyType();
		patientListType.setKey(key);
		patientListType.setProjectId(projectID);
		/*if (patientSetRefId.compareTo("-1") == 0) {
			patientListType.setPatientSetCollId(null);
			patientListType.setEntirePatientSet(true);
		} else {
		...
		return patientListType;//inputListRequestType;
	}
	
	public IsKeySetType getIsKeySetRequestType(String projectID) {

		IsKeySetType patientListType = new IsKeySetType();
		//patientListType.setKey(key);
		//patientListType.setProjectId(projectID);
		/*if (patientSetRefId.compareTo("-1") == 0) {
			patientListType.setPatientSetCollId(null);
	...
	public GetAuditType getAuditRequestType(String userID, String patientID, String projectID, String site) {

		GetAuditType patientListType = new GetAuditType();
		patientListType.setUserId(userID);
		patientListType.setProjectId(projectID);
		//if(!patientID.equalsIgnoreCase("")) {
			patientListType.setPid(patientID);
		//}
		patientListType.setSource(site);
		//PidType pidType = new PidType();
		//pidType.setSource(patientID);
		//patientListType.setPid(pidType);
		//patientListType.setComment("2013-02-22T10:47:21.000-05:00");
		/*if (patientSetRefId.compareTo("-1") == 0) {
			patientListType.setPatientSetCollId(null);
			patientListType.setEntirePatientSet(true);
		} else {
	...
	public String requestXmlMessage(String id)
			throws Exception {
		...
		GetPDOFromInputListRequestType patientSetRequestType = getPDOFromInputListRequestType(id);
	...
	public String setKeyRequestXmlMessage(String key, String projectID) throws Exception {
		//PdoQryHeaderType headerType = buildHeaderType();
		// GetPDOFromPatientSetRequestType patientSetRequestType =
		// buildPatientSetRequestType();
		
		SetKeyType patientSetRequestType = getSetKeyRequestType(key, projectID);
		edu.harvard.i2b2.crcxmljaxb.datavo.im.query.ObjectFactory obsFactory = new edu.harvard.i2b2.crcxmljaxb.datavo.im.query.ObjectFactory();
		
		BodyType bodyType = new BodyType();
		//bodyType.getAny().add(obsFactory.createPdoheader(headerType));
		bodyType.getAny().add(obsFactory.createSetKey(patientSetRequestType));
	...
	public String isKeySetRequestXmlMessage(String projectID) throws Exception {
		//PdoQryHeaderType headerType = buildHeaderType();
		// GetPDOFromPatientSetRequestType patientSetRequestType =
		// buildPatientSetRequestType();
		
		IsKeySetType patientSetRequestType = getIsKeySetRequestType(projectID);
		edu.harvard.i2b2.crcxmljaxb.datavo.im.query.ObjectFactory obsFactory = new edu.harvard.i2b2.crcxmljaxb.datavo.im.query.ObjectFactory();
		
		BodyType bodyType = new BodyType();
		//bodyType.getAny().add(obsFactory.createPdoheader(headerType));
		SetKeyType setKeyRequestType = new SetKeyType();
		setKeyRequestType.setProjectId(projectID);
		bodyType.getAny().add(obsFactory.createIsKeySet(setKeyRequestType));
	...
	public String getAuditRequestXmlMessage(String userID, String patientID, String projectID, String site) throws Exception {
		//PdoQryHeaderType headerType = buildHeaderType();
		// GetPDOFromPatientSetRequestType patientSetRequestType =
		// buildPatientSetRequestType();
		
		GetAuditType patientSetRequestType = getAuditRequestType(userID, patientID, projectID, site);
		edu.harvard.i2b2.crcxmljaxb.datavo.im.query.ObjectFactory obsFactory = new edu.harvard.i2b2.crcxmljaxb.datavo.im.query.ObjectFactory();
		
		BodyType bodyType = new BodyType();
		//bodyType.getAny().add(obsFactory.createPdoheader(headerType));
		bodyType.getAny().add(obsFactory.createGetAudit(patientSetRequestType));
