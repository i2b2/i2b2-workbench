...
import edu.harvard.i2b2.eclipse.plugins.patientSet.workplaceMessaging.ExportChildRequestMessage;
import edu.harvard.i2b2.eclipse.plugins.patientSet.workplaceMessaging.WorkplaceRequestData;
...
public class XmlUtil {
	...
	//			.convertDOMElementToString(element);
		...
		edu.harvard.i2b2.common.util.jaxb.JAXBUtil jaxbUtil = PatientSetJAXBUtil.getJAXBUtil();
